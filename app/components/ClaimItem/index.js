...
const ClaimItem = ({ employee, claim_item, claim_status, handleDeleteItem, handleEditItem, expense_types, handleChangeExpenseCategory, handleEditReceipt }) => {
  const {
    claim_item_id,
    description, 
    amount,
  ...
  if (claim_status === 'P') {
    return (
      <tr>
        <td><RIEInput value={description} change={handleEditItem.bind(this, "description", claim_item_id)} propName='description' /> <i className="ion-edit"></i> </td>
        <td>$<RIEInput value={amount.toFixed(2)} change={handleEditItem.bind(this, "amount", claim_item_id)} propName='amount' />  <i className="ion-edit"></i></td>
        <td>      
        ...
        <td><RIEInput value={comment} change={handleEditItem.bind(this, "comment", claim_item_id)} propName='comment' /> <label htmlFor="comment"><i className="ion-edit"></i></label> </td>
